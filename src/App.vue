<template>
  <div
    ...
    <div class="w-1/2 mr-5 flex flex-col">
      <!-- 数据总览图 -->
      <TotalData class="bg-opcaity-50 bg-slate-800 p-3" :data="data.totalData"/>
      <!-- 数据可视化图 -->
      <MapsChart class="bg-opcaity-50 bg-slate-800 p-3 mt-4 flex-1" :data="data.mapData" />
    </div>
    <!-- 右 -->
...
import MapsChart from "./components/MapsChart.vue"
